...
Due to the high variability of sequence data, this is not an automated process by FUSAC, but instead requires the user to manually inspect one of their reads. We recommend the user to utilize the free software  SAMtools for this purpose.

### Where can i dowload FUSAC, and is FUSAC free?
FUSAC is a publically available software, and can be downloaded free of charge from it's github repository: https://github.com/clinical-genomics-uppsala/fumic

### I have identified a bug or have suggestions for improving the program, where can i contact you regarding this?
All suggestions related to modifying the program should be submitted through it's github repository:: https://github.com/clinical-genomics-uppsala/fumic

### I have a question not covered by the FAQ, where can i contact you regarding this?:
All questions regarding the program should be submitted through it's github repository: https://github.com/clinical-genomics-uppsala/fumic

## Special thanks and credits
FUSAC were developed 2019 as part of the masters thesis of Hugo Swenson at the facility Clinical Genomics in Uppsala.
